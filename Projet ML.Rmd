...
1 - Charger les données. Voici la structure du dataset d'entraînement. Nous avons 10 000 observations et 12 variables 
...
2- Changement du format: nous allons renommer la variable catégorie, pour enlever l'accent et convertir celle-ci et la région au format nominal. Il vont nous rester uniquement deux variables en format numérique, l'âge et le revenue
```{r}
...
3- Completer avec les données géographiques
...
Nous verifions que l'imputation respecte bien la structure des données orginal
