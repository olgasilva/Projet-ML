...
```
**La valeur optimale de CP est `r mincp`**, avec un **xerror de 0.12343**. Dans le graphique suivant on observe bien la diminution de xerror qui atteint son minimum et ensuite remonte à nouveau.
...
Nous allons obtenir l'importance des variables pour faire les splits de l'arbre de décision :

```{r,fig.height = 3.5, fig.width = 6}
barplot(final.tree$variable.importance, main="Importance des Variables",
xlab="Variables",col = "cyan",las=2)
```
...
2 - Separer la variable à predire
