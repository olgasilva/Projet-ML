...
```
Dans le jeu d'apprentissage, seule la variable "revenue" est manquante pour `r revtNA` valeurs, soit `r txrevtNA`% de valeurs manquantes.


**Identifier la cause des revenus manquants**

Avant de traiter ce problème, regardons pourquoi et quand les données sont manquantes. 
...
Selon le graphique, il y a que trois catégories sans revenu (10, 11 et 12).  
   - des personnes sans revenu : chômeurs, inactifs et retraités. 
