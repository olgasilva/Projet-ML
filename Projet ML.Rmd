...
```{r}
ggplot(learn_complete, aes(x = cible, y = age, fill = sex)) + geom_boxplot()
table(learn_complete$sex, learn_complete$cible)
```
```{r}
ggplot(learn_complete, aes(reg))+geom_bar(aes(fill=cible))
table(learn_complete$reg, learn_complete$cible)
```

```{r}
ggplot(learn_complete, aes(categorie))+geom_bar(aes(fill=cible))
table(learn_complete$categorie, learn_complete$cible)
```


```{r}
ggplot(learn_complete, aes(city.type))+geom_bar(aes(fill=cible))
