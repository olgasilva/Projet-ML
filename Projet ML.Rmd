...
ggplot(learn, aes(x = rev.mv, fill = cible)) + 
  ...
  scale_fill_manual(label=c("Echec","Succès")) +
  geom_bar(col = "black") 
...
p3=ggplot(learn, aes(x = revmv.cible, fill = sex)) + 
  ...
  scale_fill_manual(values=c("red","blue"),label=c("Femme","Homme"))
  geom_bar(col = "black") 
...
L'âge présente une particularité : en effet les personnes de plus de 70 ans et à forte majorité celles de moins de 20 ans n'ont pas indiqué leur revenu et ne sent pas la cible de la campagne.  
La catégorie socio-professionnelle explique l'absence d'indication de revenu : en effet, il apparait que les étudiants, les chômeurs, les inactifs et les retraités soient les seuls à n'avoir pas renseigné leur revenu.  

**Les valeurs manquantes du revenu viennent donc des CSP : 10 Etudiants - 11 Chômeurs - 12 Inactifs  et 13 Retraités.**
...
ggplot(learn, aes(cible,categorie))+geom_boxplot(fill="darkorchid")
